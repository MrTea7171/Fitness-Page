...
const ContactUs = ({ setSelectedPage }: Props) => {
  const inputStyle = `w-full rounded-lg bg-primary-300 px-5 py-3 mb-5 placeholder-white`;
  const {
    register,
    trigger,
    formState: { errors },
        ...
        <div className="mt-10 justify-between gap-8 md:flex">
          ...
          >
            <form
              target="_blank"
              method="POST"
              action="https://formsubmit.co/a9de58303f338235c08eb7842da67cff"
              onSubmit={onSubmit}
            >
              <input
              ...
              <button
                type="submit"
                className="transition-500 mt-5 rounded-lg bg-secondary-500 px-20 py-3 hover:text-white"
              >
                Submit
              </button>
            </form>
